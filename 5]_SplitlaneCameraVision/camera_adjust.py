...
cam_props = {'brightness': 128, 'contrast': 128, 'saturation': 180,
             ...
             'exposure_absolute': -3, 'exposure_auto_priority': 0,
...
for key in cam_props:
    subprocess.call(['v4l2-ctl -d c:/Users/Sophie Banks/OneDrive - Massey University/Documents/capstone/Capstone/5]_SplitlaneCameraVision -c {}={}'.format(key, str(cam_props[key]))],
                    shell=True)
