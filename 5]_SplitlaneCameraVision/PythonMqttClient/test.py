...
# Global vars
broker_address = "192.168.137.111"     # MQTT broker address - will be "192.168.1.30" on site
...
lapmsg_cols = ["red","green","yellow","red","yellow","blue","green","green","red","red","blue","green"]
lapmsg_lane = ["left","right","right","right","left","left","right","right","right","left"]
time_count = 0

client.publish("raceinfo","{\"KartList\": [{\"Colour\": \"red\",\"Number\": 17},{\"Colour\": \"green\",\"Number\": 23},{\"Colour\": \"blue\",\"Number\": 9}],\"RequiredLaps\": [8,8,20]}",1)
client.publish("command/race","start",1)
