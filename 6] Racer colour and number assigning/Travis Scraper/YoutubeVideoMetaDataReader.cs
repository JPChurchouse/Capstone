...
//uses the "HtmlAgilityPack" NuGet package library package.
//-- [Visual Studio] - [top bar] - [Project] - [manage NuGet packages...] - [search]
using System.Runtime.InteropServices;


//---------
//---------
//This script is only ever called by other scripts. so it can be static and does not need to inherit from MonoBehaviour
//---------
//---------
public static class YoutubeVideoMetaDataReader
{
    ...
    //void Start()
    //{
        //string url = "https://www.youtube.com/watch?v=pjolhlLBb6g&ab_channel=WillJosephCook";
        //string url = "https://www.youtube.com/watch?v=Wp6W3RBkQac&ab_channel=littlecubesandtea";
        //string url = "https://www.youtube.com/watch?v=wbpMiKiSKm8&ab_channel=SebastianLague";


        //FindYoutubeVideoMetaDataFromUrl( url );
    //}
